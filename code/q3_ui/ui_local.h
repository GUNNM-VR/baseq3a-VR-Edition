...
// ui_VRconf.c
//
extern void UI_VRconfMenu( void );
extern void VRconf_Cache( void );
...
extern void			UI_MouseEvent( int dx, int dy, int dz );
...
menucommon_s* get_VR_focusItem( void );
