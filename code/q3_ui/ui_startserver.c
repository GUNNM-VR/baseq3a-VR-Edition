...
// GUNNM TODO : g_allowDeathCam & cg_allowDeathCam are not tested in game at the moment
...
typedef struct {
	...
	menuradiobutton_s	itemTimer;
#endif
#ifdef USE_DEATHCAM
	menuradiobutton_s	allowDeathCam;
#endif
} serveroptions_t;
...
#endif
#ifdef USE_ITEM_TIMERS
	itemTimer	 = s_serveroptions.itemTimer.curvalue;
#endif
#ifdef USE_DEATHCAM
	allowDeathCam = s_serveroptions.allowDeathCam.curvalue;
#endif
	//set maxclients
...
#ifdef USE_GRAPPLING_HOOK
	trap_Cvar_SetValue("g_PureAllowHook", grapple);
#endif
#ifdef USE_ITEM_TIMERS
	trap_Cvar_SetValue("g_itemTimer", itemTimer);
#endif
#ifdef USE_DEATHCAM
	trap_Cvar_SetValue("g_allowDeathCam", allowDeathCam);
#endif
...
#ifdef USE_GRAPPLING_HOOK
	s_serveroptions.grapple.curvalue = Com_Clamp( 0, 1, trap_Cvar_VariableValue( "g_PureAllowHook" ) );
#endif
#ifdef USE_ITEM_TIMERS
	s_serveroptions.itemTimer.curvalue = Com_Clamp( 0, 1, trap_Cvar_VariableValue( "cg_itemTimer" ) );
#endif
#ifdef USE_DEATHCAM
	s_serveroptions.allowDeathCam.curvalue = Com_Clamp(0, 1, trap_Cvar_VariableValue("cg_allowDeathCam"));
#endif
	// set the map pic
	info = UI_GetArenaInfoByNumber( s_startserver.maplist[ s_startserver.currentmap ]);
...
#ifdef USE_ITEM_TIMERS
	y += BIGCHAR_HEIGHT + 2;
	s_serveroptions.itemTimer.generic.type = MTYPE_RADIOBUTTON;
	s_serveroptions.itemTimer.generic.flags = QMF_PULSEIFFOCUS | QMF_SMALLFONT;
	s_serveroptions.itemTimer.generic.x = OPTIONS_X;
	s_serveroptions.itemTimer.generic.y = y;
	s_serveroptions.itemTimer.generic.name = "PowerUp counter:";
#endif
#ifdef USE_DEATHCAM
	y += BIGCHAR_HEIGHT + 2;
	s_serveroptions.allowDeathCam.generic.type = MTYPE_RADIOBUTTON;
	s_serveroptions.allowDeathCam.generic.flags = QMF_PULSEIFFOCUS | QMF_SMALLFONT;
	s_serveroptions.allowDeathCam.generic.x = OPTIONS_X;
	s_serveroptions.allowDeathCam.generic.y = y;
	s_serveroptions.allowDeathCam.generic.name = "Allow deathcam:";
#endif
...
#endif
#ifdef USE_ITEM_TIMERS
	Menu_AddItem( &s_serveroptions.menu, &s_serveroptions.itemTimer);
#endif
#ifdef USE_DEATHCAM
	Menu_AddItem( &s_serveroptions.menu, &s_serveroptions.allowDeathCam);
#endif
