...
#ifdef USE_VR
	y += SETUP_MENU_VERTICAL_SPACING;
	setupMenuInfo.VRConf.generic.type				= MTYPE_PTEXT;
	setupMenuInfo.VRConf.generic.flags				= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	setupMenuInfo.VRConf.generic.x					= 320;
	setupMenuInfo.VRConf.generic.y					= y;
	setupMenuInfo.VRConf.generic.id					= ID_VRCONF;
	setupMenuInfo.VRConf.generic.callback			= UI_SetupMenu_Event; 
	setupMenuInfo.VRConf.string						= "VR Configuration";
	setupMenuInfo.VRConf.color						= color_red;
	setupMenuInfo.VRConf.style						= UI_CENTER;
#endif
...
#ifdef USE_VR
	Menu_AddItem( &setupMenuInfo.menu, &setupMenuInfo.VRConf );
#endif	
