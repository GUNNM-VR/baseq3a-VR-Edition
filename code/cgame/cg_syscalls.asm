...
equ trap_VR_keepRightMuzzlePos			-91
equ trap_VR_KeepRightAngles				-92

equ trap_VR_KeepLeftPos					-93
equ trap_VR_KeepLeftAngles 				-94

equ trap_R_RenderHUD					-95
equ trap_HapticEvent 					-96
