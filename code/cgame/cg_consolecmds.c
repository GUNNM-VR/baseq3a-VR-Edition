...
static void CG_NextOrder_f( void ) {
	// hack: we're not team leader before changing team (skirmish for example)
	// but this create another problem: anybody in the team can control bots
	// fixme: use default behaviour in multiplayer game
#ifdef MISSIONPACK
