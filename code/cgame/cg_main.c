...
*/
#ifdef USE_NATIVE_HACK
DLLEXPORT intptr_t vmMain(int command, int arg0, int arg1, int arg2, int arg3, int arg4) {
#else
DLLEXPORT intptr_t vmMain( int command, int arg0, int arg1, int arg2 ) {
...
#ifdef USE_NATIVE_HACK
	{
		...
		ptr[0] = arg3;
		ptr[1] = arg4;
		vrinfo = (vr_clientinfo_t *)(*(long *)(ptr));
	}
#endif
...
#endif
		CG_MouseEvent(arg0, arg1, arg2); // arg2 : cursor z intersection point
		return 0;
...
//vmCvar_t	cg_cyclegrapple;//GUNNM TODO ?
#endif
#ifdef USE_VIRTUAL_KEYBOARD
vmCvar_t	showVirtualKeyboard;
#endif
#ifdef USE_VR
vmCvar_t	VR_hide_torso;
vmCvar_t	VR_angle_hide_torso;
#endif
#ifdef USE_VIRTUAL_MENU
vmCvar_t 	menu_distance;
#endif

#ifdef USE_LASER_SIGHT
vmCvar_t	laserBeam;
vmCvar_t	laserBeamStabilized;
vmCvar_t 	laserBeamRGBA;
#endif

vmCvar_t 	vr_controller_type;
...
static const cvarTable_t cvarTable[] = {
...
#ifdef USE_NEOHUD
	{ &cg_drawPing, "cg_drawPing", "1", CVAR_ARCHIVE },
#endif
	...
	{ &laserBeam, "laserBeam", "0", CVAR_USERINFO },

	{ &laserBeamStabilized, "laserBeamStabilized", "1", CVAR_USERINFO },
	{ &showVirtualKeyboard, "showVirtualKeyboard", "0", CVAR_USERINFO },

	{ &VR_hide_torso, "VR_hide_torso", "0", CVAR_USERINFO },
	{ &VR_angle_hide_torso, "VR_angle_hide_torso", "5", CVAR_USERINFO },
	{ &laserBeamRGBA, "laserBeamRGBA", "FFC0C0C0", CVAR_USERINFO },
...
#ifdef USE_GRAPPLING_HOOK
//	{ &cg_cyclegrapple, "cg_cyclegrapple", "1", CVAR_ARCHIVE},//GUNNM TODO
#endif
#if defined MISSIONPACK || defined USE_NEOHUD
	{ &cg_currentSelectedPlayer, "cg_currentSelectedPlayer", "0", CVAR_ARCHIVE},
	{ &cg_hudFiles, "cg_hudFiles", DEFAULT_HUD, CVAR_ARCHIVE },
#endif
#ifdef MISSIONPACK
...
#ifdef USE_ITEM_TIMERS
	{ &cg_itemTimer, "g_itemTimer", "1", CVAR_SERVERINFO },
#endif
...
#ifdef USE_VIRTUAL_MENU	
	{ &menu_distance, "menu_distance", "80", CVAR_ARCHIVE },
#endif
	{ &vr_controller_type, "vr_controller_type", "0", CVAR_ARCHIVE },
};
...
#if defined MISSIONPACK || defined USE_GRAPPLING_HOOK
	// reuse the nailgun sounds from the MISSIONPACK for the grappling hook
...
#ifdef USE_ITEM_TIMERS
	cgs.media.timerSlices[0] = trap_R_RegisterShader( "gfx/2d/timer/slice_5" );
	cgs.media.timerSlices[1] = trap_R_RegisterShader( "gfx/2d/timer/slice_7" );
	cgs.media.timerSlices[2] = trap_R_RegisterShader( "gfx/2d/timer/slice_12" );
	cgs.media.timerSlices[3] = trap_R_RegisterShader( "gfx/2d/timer/slice_24" );
#endif
#ifdef USE_VIRTUAL_MENU
	cgs.media.menu_texture_shader = trap_R_RegisterShader( "textures/sfx/logo512.tga" );// menu as seen by others players
#endif	
...
#ifdef USE_WEAPON_WHEEL
	//cgs.media.needle = trap_R_RegisterShader("gfx/2d/weaponwheel/needle3");
	cgs.media.needle = trap_R_RegisterShader("gfx/2d/weaponwheel/needle");
	cgs.media.wheelHollow = trap_R_RegisterShader("gfx/2d/weaponwheel/slice_h_7");
#endif
...
//#ifdef USE_GRAPPLING_HOOK
			/*if (weaponId == WP_GRAPPLING_HOOK) {// TODO if allow grapple hook
				continue;
			}*/
//#endif
#ifndef USE_VR
	...
	cgs.media.cursor = trap_R_RegisterShaderNoMip( "menu/art/cursor" );
#if defined MISSIONPACK || defined USE_NEOHUD
...
static void CG_RegisterClients( void ) {
	...
	// get player stand height vor VR adjust
	CG_GetModelHeight( 0 );

	// get player crouch height
	CG_GetModelHeight( 1 );
...
void CG_Init( int serverMessageNum, int serverCommandSequence, int clientNum ) {
	...
	CG_ChangeFrameResolution(cgs.glconfig.vidWidth, cgs.glconfig.vidHeight);
...
// The z arg is for getting 3D collision point
void CG_MouseEvent( int x, int y, int z ) {
	cgs.cursorX += x * cgs.cursorScaleR;
	cgs.cursorY += y * cgs.cursorScaleR;
	cgs.cursorZ = (z < 0) ? 0 : z;

	ClampFloat(cgs.screenXmin, cgs.screenXmax, cgs.cursorX);
	ClampFloat(cgs.screenYmin, cgs.screenYmax, cgs.cursorY);
}
#endif
