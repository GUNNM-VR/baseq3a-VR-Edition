...
LABELV $114
line 172
;172:	r = min(pd - pc, pn - pd - es); //fixme: warning C4018: '<' : incompatibilité signed/unsigned
ADDRLP4 76
ADDRLP4 24
INDIRP4
CVPU4 4
...
LABELV $119
line 174
;174:	if ((r = pb - pa) > es)			//warning C4018: '>' : incompatibilité signed/unsigned
ADDRLP4 84
ADDRLP4 4
INDIRP4
CVPU4 4
...
LABELV $121
line 176
;176:	if ((r = pd - pc) > es) {		//warning C4018: '>' : incompatibilité signed/unsigned
ADDRLP4 92
ADDRLP4 24
INDIRP4
CVPU4 4
