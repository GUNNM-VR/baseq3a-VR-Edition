...
LABELV $489
line 1019
;1018:#if defined MISSIONPACK || defined USE_NEOHUD
...
;1489:			if ( ent->s.eType == ET_MISSILE
ADDRLP4 4
INDIRP4
CNSTI4 4
ADDP4
...
EQI4 $653
line 1493
;1490:#ifdef USE_GRAPPLING_HOOK
;1491:				&& ent->s.weapon != WP_GRAPPLING_HOOK
;1492:#endif
;1493:				) {
line 1494
;1494:				if ( *s == qfalse ) {
...
ASGNI4
line 1496
;1496:					trap_BotLibUpdateEntity( i, NULL );
ADDRLP4 0
INDIRI4
ARGI4
CNSTP4 0
...
line 1501
;1499:			}
;1500:			// do not update event only entities
;1501:			if ( ent->s.eType > ET_EVENTS ) {
ADDRLP4 4
INDIRP4
CNSTI4 4
ADDP4
...
ASGNI4
line 1504
;1504:					trap_BotLibUpdateEntity( i, NULL );
ADDRLP4 0
INDIRI4
ARGI4
CNSTP4 0
...
;1509:			// never link prox mine triggers
;1510:			if (ent->r.contents == CONTENTS_TRIGGER) {
;1511:				if (ent->touch == ProximityMine_Trigger) {
;1512:					trap_BotLibUpdateEntity(i, NULL);
;1513:					continue;
;1514:				}
;1515:			}
;1516:#endif
;1517:			//
;1518:			memset(&state, 0, sizeof(bot_entitystate_t));
ADDRLP4 8
ARGP4
CNSTI4 0
ARGI4
...
line 1520
;1519:			//
;1520:			VectorCopy(ent->r.currentOrigin, state.origin);
ADDRLP4 8+8
ADDRLP4 4
INDIRP4
CNSTI4 984
...
ASGNB 12
line 1521
;1521:			if (i < MAX_CLIENTS) {
ADDRLP4 0
INDIRI4
CNSTI4 64
GEI4 $662
line 1522
;1522:				VectorCopy(ent->s.apos.trBase, state.angles);
ADDRLP4 8+20
ADDRLP4 4
INDIRP4
CNSTI4 60
...
LABELV $662
line 1524
;1524:				VectorCopy(ent->r.currentAngles, state.angles);
ADDRLP4 8+20
ADDRLP4 4
INDIRP4
CNSTI4 996
...
LABELV $663
line 1526
;1526:			VectorCopy(ent->s.origin2, state.old_origin);
ADDRLP4 8+32
ADDRLP4 4
INDIRP4
CNSTI4 104
...
ASGNB 12
line 1527
;1527:			VectorCopy(ent->r.mins, state.mins);
ADDRLP4 8+44
ADDRLP4 4
INDIRP4
CNSTI4 932
...
ASGNB 12
line 1528
;1528:			VectorCopy(ent->r.maxs, state.maxs);
ADDRLP4 8+56
ADDRLP4 4
INDIRP4
CNSTI4 944
...
ASGNI4
line 1531
;1531:			if (ent->r.bmodel) state.solid = SOLID_BSP;
ADDRLP4 4
INDIRP4
CNSTI4 928
ADDP4
...
LABELV $670
line 1532
;1532:			else state.solid = SOLID_BBOX;
ADDRLP4 8+72
CNSTI4 2
ASGNI4
LABELV $671
line 1533
;1533:			state.groundent = ent->s.groundEntityNum;
ADDRLP4 8+68
ADDRLP4 4
INDIRP4
CNSTI4 148
...
ASGNI4
line 1534
;1534:			state.modelindex = ent->s.modelindex;
ADDRLP4 8+76
ADDRLP4 4
INDIRP4
CNSTI4 160
...
ASGNI4
line 1535
;1535:			state.modelindex2 = ent->s.modelindex2;
ADDRLP4 8+80
ADDRLP4 4
INDIRP4
CNSTI4 164
...
ASGNI4
line 1538
;1538:			state.eventParm = ent->s.eventParm;
ADDRLP4 8+92
ADDRLP4 4
INDIRP4
CNSTI4 184
...
ASGNI4
line 1539
;1539:			state.powerups = ent->s.powerups;
ADDRLP4 8+96
ADDRLP4 4
INDIRP4
CNSTI4 188
...
ASGNI4
line 1540
;1540:			state.legsAnim = ent->s.legsAnim;
ADDRLP4 8+104
ADDRLP4 4
INDIRP4
CNSTI4 196
...
ASGNI4
line 1541
;1541:			state.torsoAnim = ent->s.torsoAnim;
ADDRLP4 8+108
ADDRLP4 4
INDIRP4
CNSTI4 200
...
ASGNI4
line 1542
;1542:			state.weapon = ent->s.weapon;
ADDRLP4 8+100
ADDRLP4 4
INDIRP4
CNSTI4 192
...
ASGNI4
line 1545
;1545:			trap_BotLibUpdateEntity( i, &state );
ADDRLP4 0
INDIRI4
ARGI4
ADDRLP4 8
...
LABELV $684
line 1555
;1555:		if( !botstates[i] || !botstates[i]->inuse ) {
ADDRLP4 140
ADDRGP4 botstates
ASGNP4
ADDRLP4 0
...
;1557:		}
;1558:		//
;1559:		botstates[i]->botthink_residual += elapsed_time;
ADDRLP4 144
ADDRLP4 0
INDIRI4
CNSTI4 2
...
line 1561
;1560:		//
;1561:		if ( botstates[i]->botthink_residual >= thinktime ) {
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
LTI4 $692
line 1562
;1562:			botstates[i]->botthink_residual -= thinktime;
ADDRLP4 148
ADDRLP4 0
INDIRI4
CNSTI4 2
...
line 1564
;1563:
;1564:			if (!trap_AAS_Initialized()) return qfalse;
ADDRLP4 152
ADDRGP4 trap_AAS_Initialized
CALLI4
ASGNI4
...
NEI4 $696
line 1567
;1567:				BotAI(i, (float) thinktime / 1000);
ADDRLP4 0
INDIRI4
ARGI4
ADDRLP4 124
...
;1571:
;1572:
;1573:	// execute bot user commands every frame
...
LABELV $699
line 1575
;1575:		if( !botstates[i] || !botstates[i]->inuse ) {
ADDRLP4 140
ADDRGP4 botstates
ASGNP4
ADDRLP4 0
...
line 1578
;1577:		}
;1578:		if( g_entities[i].client->pers.connected != CON_CONNECTED ) {
ADDRLP4 0
INDIRI4
CNSTI4 1312
MULI4
...
;1580:		}
;1581:
;1582:		BotUpdateInput(botstates[i], time, elapsed_time);
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
pop
line 1583
;1583:		trap_BotUserCommand(botstates[i]->client, &botstates[i]->lastucmd);
ADDRLP4 148
ADDRGP4 botstates
ASGNP4
ADDRLP4 0
...
;1592:==============
;1593:*/
;1594:int BotInitLibrary( void ) {
line 1598
;1595:	char buf[MAX_CVAR_VALUE_STRING];
;1596:
;1597:	//set the maxclients and maxentities library variables before calling BotSetupLibrary
;1598:	trap_Cvar_VariableStringBuffer( "sv_maxclients", buf, sizeof( buf ) );
ADDRGP4 $711
ARGP4
ADDRLP4 0
ARGP4
...
LABELV $712
line 1601
;1601:	trap_BotLibVarSet( "maxclients", buf );
ADDRGP4 $715
ARGP4
ADDRLP4 0
ARGP4
...
line 1603
;1602:
;1603:	Com_sprintf(buf, sizeof(buf), "%d", MAX_GENTITIES);
ADDRLP4 0
ARGP4
CNSTI4 256
ARGI4
...
pop
line 1604
;1604:	trap_BotLibVarSet("maxentities", buf);
ADDRGP4 $716
ARGP4
ADDRLP4 0
ARGP4
...
line 1606
;1605:	//bsp checksum
;1606:	trap_Cvar_VariableStringBuffer("sv_mapChecksum", buf, sizeof(buf));
ADDRGP4 $717
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $718
line 1608
;1608:		trap_BotLibVarSet( "sv_mapChecksum", buf );
ADDRGP4 $717
ARGP4
ADDRLP4 0
ARGP4
...
line 1611
;1609:
;1610:	//maximum number of aas links
;1611:	trap_Cvar_VariableStringBuffer("max_aaslinks", buf, sizeof(buf));
ADDRGP4 $720
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $721
line 1613
;1613:		trap_BotLibVarSet( "max_aaslinks", buf );
ADDRGP4 $720
ARGP4
ADDRLP4 0
ARGP4
...
line 1616
;1614:
;1615:	//maximum number of items in a level
;1616:	trap_Cvar_VariableStringBuffer("max_levelitems", buf, sizeof(buf));
ADDRGP4 $723
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $724
line 1618
;1618:		trap_BotLibVarSet( "max_levelitems", buf );
ADDRGP4 $723
ARGP4
ADDRLP4 0
ARGP4
...
;1619:
;1620:	//game type
;1621:	trap_Cvar_VariableStringBuffer("g_gametype", buf, sizeof(buf));
ADDRGP4 $306
ARGP4
ADDRLP4 0
ARGP4
...
LABELV $726
line 1624
;1624:	trap_BotLibVarSet("g_gametype", buf);
ADDRGP4 $306
ARGP4
ADDRLP4 0
ARGP4
...
pop
line 1626
;1625:	//bot developer mode and log file
;1626:	trap_BotLibVarSet("bot_developer", bot_developer.string);
ADDRGP4 $728
ARGP4
...
pop
line 1627
;1627:	trap_BotLibVarSet("log", buf);
ADDRGP4 $730
ARGP4
ADDRLP4 0
ARGP4
...
line 1629
;1628:	//no chatting
;1629:	trap_Cvar_VariableStringBuffer("bot_nochat", buf, sizeof(buf));
ADDRGP4 $731
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $732
line 1631
;1631:		trap_BotLibVarSet( "nochat", "0" );
ADDRGP4 $734
ARGP4
ADDRGP4 $619
ARGP4
...
line 1634
;1632:
;1633:	//visualize jump pads
;1634:	trap_Cvar_VariableStringBuffer("bot_visualizejumppads", buf, sizeof(buf));
ADDRGP4 $735
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $736
line 1636
;1636:		trap_BotLibVarSet( "bot_visualizejumppads", buf );
ADDRGP4 $735
ARGP4
ADDRLP4 0
ARGP4
...
line 1639
;1637:	
;1638:	//forced clustering calculations
;1639:	trap_Cvar_VariableStringBuffer("bot_forceclustering", buf, sizeof(buf));
ADDRGP4 $738
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $739
line 1641
;1641:		trap_BotLibVarSet( "forceclustering", buf );
ADDRGP4 $741
ARGP4
ADDRLP4 0
ARGP4
...
line 1644
;1642:	
;1643:	//forced reachability calculations
;1644:	trap_Cvar_VariableStringBuffer("bot_forcereachability", buf, sizeof(buf));
ADDRGP4 $742
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $743
line 1646
;1646:		trap_BotLibVarSet( "forcereachability", buf );
ADDRGP4 $745
ARGP4
ADDRLP4 0
ARGP4
...
line 1649
;1647:	
;1648:	//force writing of AAS to file
;1649:	trap_Cvar_VariableStringBuffer("bot_forcewrite", buf, sizeof(buf));
ADDRGP4 $746
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $747
line 1651
;1651:		trap_BotLibVarSet( "forcewrite", buf );
ADDRGP4 $749
ARGP4
ADDRLP4 0
ARGP4
...
line 1654
;1652:	
;1653:	//no AAS optimization
;1654:	trap_Cvar_VariableStringBuffer("bot_aasoptimize", buf, sizeof(buf));
ADDRGP4 $750
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $751
line 1656
;1656:		trap_BotLibVarSet( "aasoptimize", buf );
ADDRGP4 $753
ARGP4
ADDRLP4 0
ARGP4
...
;1657:	
;1658:	//
;1659:	trap_Cvar_VariableStringBuffer("bot_saveroutingcache", buf, sizeof(buf));
ADDRGP4 $624
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $754
line 1661
;1661:		trap_BotLibVarSet( "saveroutingcache", buf );
ADDRGP4 $623
ARGP4
ADDRLP4 0
ARGP4
...
line 1664
;1662:	
;1663:	//reload instead of cache bot character files
;1664:	trap_Cvar_VariableStringBuffer("bot_reloadcharacters", buf, sizeof(buf));
ADDRGP4 $315
ARGP4
ADDRLP4 0
ARGP4
...
LABELV $756
line 1667
;1667:	trap_BotLibVarSet("bot_reloadcharacters", buf);
ADDRGP4 $315
ARGP4
ADDRLP4 0
ARGP4
...
line 1669
;1668:	//base directory
;1669:	trap_Cvar_VariableStringBuffer("fs_basepath", buf, sizeof(buf));
ADDRGP4 $758
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $759
line 1671
;1671:		trap_BotLibVarSet( "basedir", buf );
ADDRGP4 $761
ARGP4
ADDRLP4 0
ARGP4
...
;1672:
;1673:	//home directory
;1674:	trap_Cvar_VariableStringBuffer("fs_homepath", buf, sizeof(buf));
ADDRGP4 $762
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $763
line 1676
;1676:		trap_BotLibVarSet( "homedir", buf );
ADDRGP4 $765
ARGP4
ADDRLP4 0
ARGP4
...
;1677:
;1678:	//game directory
;1679:	trap_Cvar_VariableStringBuffer( "fs_game", buf, sizeof( buf ) );
ADDRGP4 $766
ARGP4
ADDRLP4 0
ARGP4
...
EQI4 $767
line 1681
;1681:		trap_BotLibVarSet( "gamedir", buf );
ADDRGP4 $769
ARGP4
ADDRLP4 0
ARGP4
...
;1684:	trap_BotLibDefine("MISSIONPACK");
;1685:#endif
;1686:	//setup the bot library
;1687:	return trap_BotLibSetup();
ADDRLP4 256
...
;1693:==============
;1694:*/
;1695:int BotAISetup( int restart ) {
line 1698
;1696:	int			errnum;
;1697:
;1698:	trap_Cvar_Register(&bot_thinktime, "bot_thinktime", "100", CVAR_CHEAT);
ADDRGP4 bot_thinktime
ARGP4
ADDRGP4 $628
ARGP4
...
pop
line 1699
;1699:	trap_Cvar_Register(&bot_memorydump, "bot_memorydump", "0", CVAR_CHEAT);
ADDRGP4 bot_memorydump
ARGP4
ADDRGP4 $618
ARGP4
...
pop
line 1700
;1700:	trap_Cvar_Register(&bot_saveroutingcache, "bot_saveroutingcache", "0", CVAR_CHEAT);
ADDRGP4 bot_saveroutingcache
ARGP4
ADDRGP4 $624
ARGP4
...
pop
line 1701
;1701:	trap_Cvar_Register(&bot_pause, "bot_pause", "0", CVAR_CHEAT);
ADDRGP4 bot_pause
ARGP4
ADDRGP4 $772
ARGP4
...
pop
line 1702
;1702:	trap_Cvar_Register(&bot_report, "bot_report", "0", CVAR_CHEAT);
ADDRGP4 bot_report
ARGP4
ADDRGP4 $773
ARGP4
...
pop
line 1703
;1703:	trap_Cvar_Register(&bot_testsolid, "bot_testsolid", "0", CVAR_CHEAT);
ADDRGP4 bot_testsolid
ARGP4
ADDRGP4 $774
ARGP4
...
pop
line 1704
;1704:	trap_Cvar_Register(&bot_testclusters, "bot_testclusters", "0", CVAR_CHEAT);
ADDRGP4 bot_testclusters
ARGP4
ADDRGP4 $775
ARGP4
...
pop
line 1705
;1705:	trap_Cvar_Register(&bot_developer, "bot_developer", "0", CVAR_CHEAT);
...
pop
line 1706
;1706:	trap_Cvar_Register(&bot_interbreedchar, "bot_interbreedchar", "", 0);
ADDRGP4 bot_interbreedchar
ARGP4
ADDRGP4 $325
ARGP4
...
pop
line 1707
;1707:	trap_Cvar_Register(&bot_interbreedbots, "bot_interbreedbots", "10", 0);
...
pop
line 1708
;1708:	trap_Cvar_Register(&bot_interbreedcycle, "bot_interbreedcycle", "20", 0);
...
pop
line 1709
;1709:	trap_Cvar_Register(&bot_interbreedwrite, "bot_interbreedwrite", "", 0);
ADDRGP4 bot_interbreedwrite
ARGP4
ADDRGP4 $298
ARGP4
...
line 1712
;1710:
;1711:	//if the game is restarted for a tournament
;1712:	if (restart) {
ADDRFP4 0
INDIRI4
CNSTI4 0
...
;1714:	}
;1715:
;1716:	//initialize the bot states
;1717:	memset( botstates, 0, sizeof(botstates) );
ADDRGP4 botstates
ARGP4
CNSTI4 0
ARGI4
...
;1729:==============
;1730:*/
;1731:int BotAIShutdown( int restart ) {
line 1736
;1732:
;1733:	int i;
;1734:
;1735:	//if the game is restarted for a tournament
;1736:	if ( restart ) {
ADDRFP4 0
INDIRI4
CNSTI4 0
EQI4 $785
line 1738
;1737:		//shutdown all the bots in the botlib
...
LABELV $787
line 1739
;1739:			if ( botstates[i] && botstates[i]->inuse ) {
ADDRLP4 8
ADDRGP4 botstates
ASGNP4
ADDRLP4 0
...
EQI4 $792
line 1740
;1740:				BotAIShutdownClient(botstates[i]->client, restart);
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
LTI4 $787
line 1744
;1743:		//don't shutdown the bot library
;1744:	}
ADDRGP4 $786
JUMPV
LABELV $785
