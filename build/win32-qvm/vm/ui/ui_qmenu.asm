...
export get_VR_focusItem
proc get_VR_focusItem 0 0
line 1753
;1744:}
;1745:
;1746:/*
;1747:=================
;1748:Menu focused item
;1749:=================
;1750:*/
;1751:menucommon_s* keepFocusItem;
;1752:
;1753:menucommon_s* get_VR_focusItem() {
line 1754
;1754:	return keepFocusItem;
ADDRGP4 keepFocusItem
INDIRP4
RETP4
LABELV $578
endproc get_VR_focusItem 0 0
export set_VR_focusItem
proc set_VR_focusItem 0 0
line 1757
;1755:}
;1756:
;1757:void set_VR_focusItem(menucommon_s *item) {
line 1758
;1758:	keepFocusItem = item;
ADDRGP4 keepFocusItem
ADDRFP4 0
INDIRP4
ASGNP4
...
;1759:}
LABELV $579
endproc set_VR_focusItem 0 0
export Menu_DefaultKey
proc Menu_DefaultKey 92 8
line 1767
;1760:
;1761:/*
;1762:=================
;1763:Menu_DefaultKey
;1764:=================
;1765:*/
;1766:sfxHandle_t Menu_DefaultKey( menuframework_s *m, int key )
;1767:{
line 1768
;1768:	sfxHandle_t		sound = 0;
ADDRLP4 4
CNSTI4 0
ASGNI4
line 1776
;1769:	menucommon_s	*item;
;1770:	int				cursor_prev;
;1771:#ifdef USE_VIRTUAL_KEYBOARD
;1772:	int 			showVirtualKeyboard;
;1773:#endif
;1774:
;1775:	// menu system keys
;1776:	switch ( key )
ADDRLP4 16
ADDRFP4 4
INDIRI4
...
line 1789
;1786:
;1787:#ifdef USE_VIRTUAL_KEYBOARD
;1788:	// prevent cursor to focus another item when using virtual keyboard
;1789:	showVirtualKeyboard = (int)trap_Cvar_VariableValue( "showVirtualKeyboard" );
ADDRGP4 $588
ARGP4
ADDRLP4 24
...
ASGNI4
line 1790
;1790:	if(showVirtualKeyboard && keepFocusItem)
ADDRLP4 8
INDIRI4
CNSTI4 0
EQI4 $589
...
line 1797
;1795:	
;1796:	// route key stimulus to widget
;1797:	if (item && !(item->flags & (QMF_GRAYED|QMF_INACTIVE)))
ADDRLP4 0
INDIRP4
CVPU4 4
CNSTU4 0
...
LABELV $596
line 1802
;1801:			case MTYPE_SPINCONTROL:
;1802:				sound = SpinControl_Key( (menulist_s*)item, key );
ADDRLP4 0
INDIRP4
ARGP4
ADDRFP4 4
...
line 1806
;1804:
;1805:			case MTYPE_RADIOBUTTON:
;1806:				sound = RadioButton_Key( (menuradiobutton_s*)item, key );
ADDRLP4 0
INDIRP4
ARGP4
ADDRFP4 4
...
line 1810
;1808:
;1809:			case MTYPE_SLIDER:
;1810:				sound = Slider_Key( (menuslider_s*)item, key );
ADDRLP4 0
INDIRP4
ARGP4
ADDRFP4 4
...
line 1814
;1812:
;1813:			case MTYPE_SCROLLLIST:
;1814:				sound = ScrollList_Key( (menulist_s*)item, key );
ADDRLP4 0
INDIRP4
ARGP4
ADDRFP4 4
...
line 1818
;1816:
;1817:			case MTYPE_FIELD:
;1818:				sound = MenuField_Key( (menufield_s*)item, &key );
ADDRLP4 0
INDIRP4
ARGP4
ADDRFP4 4
...
;1831:#ifndef NDEBUG
;1832:		case K_F11:
;1833:			trap_Cmd_ExecuteText( EXEC_APPEND, "screenshot\n" );
CNSTI4 2
ARGI4
ADDRGP4 $608
ARGP4
...
line 1842
;1839:#endif
;1840:		case K_KP_UPARROW:
;1841:		case K_UPARROW:
;1842:			cursor_prev    = m->cursor;
ADDRLP4 12
ADDRFP4 0
INDIRP4
INDIRI4
...
;1851:
;1852:		case K_TAB:
;1853:		case K_KP_DOWNARROW:
;1854:		case K_DOWNARROW:
;1855:			cursor_prev    = m->cursor;
ADDRLP4 12
ADDRFP4 0
INDIRP4
INDIRI4
...
EQU4 $606
line 1868
;1868:				if ((item->flags & QMF_HASMOUSEFOCUS) && !(item->flags & (QMF_GRAYED|QMF_INACTIVE)))
ADDRLP4 0
INDIRP4
CNSTI4 44
ADDP4
...
NEU4 $606
line 1869
;1869:					return (Menu_ActivateItem( m, item ));
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0
...
EQU4 $606
line 1895
;1895:				if (!(item->flags & (QMF_MOUSEONLY|QMF_GRAYED|QMF_INACTIVE)))
ADDRLP4 0
INDIRP4
CNSTI4 44
ADDP4
...
NEU4 $606
line 1896
;1896:					return (Menu_ActivateItem( m, item ));
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0
...
;1906:=================
;1907:*/
;1908:void Menu_Cache( void )
;1909:{
line 1910
;1910:	uis.charset			= trap_R_RegisterShaderNoMip( "gfx/2d/bigchars" );
ADDRGP4 $640
ARGP4
ADDRLP4 0
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1911
;1911:	uis.charsetProp		= trap_R_RegisterShaderNoMip( "menu/art/font1_prop.tga" );
ADDRGP4 $642
ARGP4
ADDRLP4 4
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1912
;1912:	uis.charsetPropGlow	= trap_R_RegisterShaderNoMip( "menu/art/font1_prop_glo.tga" );
ADDRGP4 $644
ARGP4
ADDRLP4 8
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1913
;1913:	uis.charsetPropB	= trap_R_RegisterShaderNoMip( "menu/art/font2_prop.tga" );
ADDRGP4 $646
ARGP4
ADDRLP4 12
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1914
;1914:	uis.cursor          = trap_R_RegisterShaderNoMip( "menu/art/cursor" );
ADDRGP4 $648
ARGP4
ADDRLP4 16
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1915
;1915:	uis.rb_on           = trap_R_RegisterShaderNoMip( "menu/art/switch_on" );
ADDRGP4 $650
ARGP4
ADDRLP4 20
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1916
;1916:	uis.rb_off          = trap_R_RegisterShaderNoMip( "menu/art/switch_off" );
ADDRGP4 $652
ARGP4
ADDRLP4 24
ADDRGP4 trap_R_RegisterShaderNoMip
...
line 1918
;1917:
;1918:	uis.whiteShader = trap_R_RegisterShaderNoMip( "white" );
ADDRGP4 $654
ARGP4
ADDRLP4 28
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1919
;1919:	if ( uis.glconfig.hardwareType == GLHW_RAGEPRO ) {
ADDRGP4 uis+60+11288
INDIRI4
CNSTI4 3
NEI4 $655
line 1921
;1920:		// the blend effect turns to shit with the normal 
;1921:		uis.menuBackShader	= trap_R_RegisterShaderNoMip( "menubackRagePro" );
ADDRGP4 $660
ARGP4
ADDRLP4 32
ADDRGP4 trap_R_RegisterShaderNoMip
...
LABELV $655
line 1923
;1923:		uis.menuBackShader	= trap_R_RegisterShaderNoMip( "menuback" );
ADDRGP4 $662
ARGP4
ADDRLP4 32
ADDRGP4 trap_R_RegisterShaderNoMip
...
LABELV $656
line 1925
;1925:	uis.menuBackNoLogoShader = trap_R_RegisterShaderNoMip( "menubacknologo" );
ADDRGP4 $664
ARGP4
ADDRLP4 32
ADDRGP4 trap_R_RegisterShaderNoMip
...
line 1927
;1926:
;1927:	menu_in_sound	= trap_S_RegisterSound( "sound/misc/menu1.wav", qfalse );
ADDRGP4 $665
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 1928
;1928:	menu_move_sound	= trap_S_RegisterSound( "sound/misc/menu2.wav", qfalse );
ADDRGP4 $666
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 1929
;1929:	menu_out_sound	= trap_S_RegisterSound( "sound/misc/menu3.wav", qfalse );
ADDRGP4 $667
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 1930
;1930:	menu_buzz_sound	= trap_S_RegisterSound( "sound/misc/menu4.wav", qfalse );
ADDRGP4 $668
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 1931
;1931:	weaponChangeSound	= trap_S_RegisterSound( "sound/weapons/change.wav", qfalse );
ADDRGP4 $669
ARGP4
CNSTI4 0
ARGI4
...
line 1934
;1932:
;1933:	// need a nonzero sound, make an empty sound for this
;1934:	menu_null_sound = -1;
ADDRGP4 menu_null_sound
CNSTI4 -1
ASGNI4
line 1936
;1935:
;1936:	sliderBar = trap_R_RegisterShaderNoMip( "menu/art/slider2" );
ADDRGP4 $670
ARGP4
ADDRLP4 56
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1937
;1937:	sliderButton_0 = trap_R_RegisterShaderNoMip( "menu/art/sliderbutt_0" );
ADDRGP4 $671
ARGP4
ADDRLP4 60
ADDRGP4 trap_R_RegisterShaderNoMip
...
ASGNI4
line 1938
;1938:	sliderButton_1 = trap_R_RegisterShaderNoMip( "menu/art/sliderbutt_1" );
ADDRGP4 $672
ARGP4
ADDRLP4 64
ADDRGP4 trap_R_RegisterShaderNoMip
...
bss
export keepFocusItem
align 4
LABELV keepFocusItem
skip 4
align 4
